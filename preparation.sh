...
#Java
#hdiutil mount -quiet  /Volumes/store/install/jdk-7u10-macosx-x64.dmg && sudo installer -pkg  /Volumes/JDK\ 7\ Update\ 10/JDK\ 7\ Update\ 10.pkg -target /
...
#Screenflow 3.07
#hdiutil mount -quiet /Volumes/store/install/ScreenFlow\ 3.0.7.dmg && cp -R /Volumes/ScreenFlow/ScreenFlow.app  /Applications/
